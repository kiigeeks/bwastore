...
@section('title')
    Dashboard Details Products Page
@endsection
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="editor" cols="50" rows="50">{!! $product->description !!}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col text-right">
                                            <button class="btn btn-success px-5 btn-block" type="submit">Save Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <form action="{{ route('dashboard-products-gallery-upload') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <button type="button" class="btn btn-secondary btn-block mt-3" onclick="thisFileUpload()">Add Photo</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
